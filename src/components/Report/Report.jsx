...
const Report = () => {
  ...
  const [dataForChartSubCategories, setDataForChartSubCategories] =
    useState(null);
  ...
  const getIncomesCategory = useSelector(getInomesCategories);
  console.log(`getIncomesCategory`, getIncomesCategory);
  ...
  const newIncomes = getIncomesCategory.map(item => {
  ...
  console.log(`getTotalExpensesByCategories`, getTotalExpensesByCategories);
